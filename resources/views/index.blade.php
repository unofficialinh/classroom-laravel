...
@section('content')
    ...
    <div class="panel-group col-sm-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body" style="height: 120px">See and edit your profile</div>
        </div>
    </div>
    ...
    <div class="panel-group col-sm-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body" style="height: 120px">See the exercise list and submit your solution</div>
        </div>
    </div>
    ...
    <div class="panel-group col-sm-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body" style="height: 120px">Solve the challenge with everyone</div>
        </div>
    </div>
@endsection
